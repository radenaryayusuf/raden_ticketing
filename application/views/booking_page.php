 ...
 ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?php echo site_url('reservation_train/proses_faktur'); ?>" role="form">
...
// );
 ...
 $('#ModalSeat').modal();
    ...
    //    var url = "<?php echo base_url()?>index.php/reservation_train/get_kursi/"+rute_id;
    // $.get(url,function(e){
    ...
    // })
            ...
            if ($('#nama').val() != "") {
            $.ajax({
                url: '<?php echo base_url()?>index.php/reservation_train/simpan',
                type: "POST",
                data: $('.insert_pelanggan').serializeArray(), //serialize() untuk mengambil semua data di dalam form
                dataType: "html",
                success: function(){   
                 $('#ModalFaktur').modal();
                    //     var address = "<?php echo base_url() ?>index.php/reservation_train/faktur_train/"+
                    //     kode_kredit;
                    //     var thePopup = window.open(address,"Kuitansi","menubar=0,location=0,height=500,width=860");
            // window.location.replace("<?php echo site_url('reservation_train'); ?>");       
