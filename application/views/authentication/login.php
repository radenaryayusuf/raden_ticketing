...
<body class="login2">
    ...
    <div class="login animated flipInY" id="logindiv">   
       ...
       <form method="post" class="loginForm" action="<?php echo base_url().'index.php/auth/login'?>" role="login">
      <?php
      ...
      ?>
            ...
            <div class="clearfix">
            <button type="submit" name="submit" value="login" class="btn btn-primary pull-right">LOGIN</button>            </div>
