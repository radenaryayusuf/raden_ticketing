...
$this->load->view('parts/navigation');
 ...
 <div class="main-container">    <!-- START: Main Container -->
            ...
            <div class="page-header">
                <h1> Pemesanan Kereta </h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo base_url()?>">Home</a></li>
                    <li><a href="<?php echo base_url()?>">Transaksi</a></li>
                    <li class="active"> Pemesanan Kereta</li>
                </ol>
            </div>
                     ...
                     <div class="col-md-12">
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <h3 class="panel-title">Train's Reservation</h3>
                                <div class="tools">
                        ...
                        <div class="panel panel-default shadow-one">
                            <div class="panel-heading">
                                <h3 class="panel-title">1. Train Destination</h3>
                                ...
                                <div class="form-group">
                                   ...
                                   foreach ($qrutefrom as $rowrutefrom) {
                                    ...
                                    ?>
                                        ...
                                        <input type="hidden" name="name_stasiun1" id="name_stasiun1">
                                        </div>
                                    </div>
                                    <div class="form-group">
           ...
           <?php }?>
                                        ...
                                        <input type="hidden" name="name_stasiun2" id="name_stasiun2">
                                        </div>
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="panel panel-default shadow-one">
                            <div class="panel-heading">
                                <h3 class="panel-title">3. Search Train</h3>
 ...
 <div class="col-xs-13">
                                         <button type="submit" class="btn btn-labeled btn-md btn-secondary" id="search_button"><span class="btn-label"><i class="di di-search"></i></span>Search Tiket </button> 
                                         </div>
    ...
    <div class="modal modal-secondary fade" id="ModalConfir" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="<?php echo site_url('reservation_train/proses'); ?>" role="form">
...
$this->load->view('parts/footer');
        ...
        <script>
            ...
            $("button").click(function(){
                ...
                var name_stasiunI = $('#name_stasiun1').val();
                var name_stasiunII = $('#name_stasiun2').val();
               
            $.ajax({
                type  : 'POST',
                url   : '<?php echo base_url()?>index.php/reservation_train/data_kereta',
                async : false,
                dataType : 'json',
...
$('#show_rute').on('click','.choose-rute',function(){
    ...
    var infant_amount = $('#infant').val();
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('index.php/reservation_train/get_confirmation')?>",
                dataType : "JSON",
                data : {rute_id:id},
                success: function(data){
                    $.each(data,function(rute_id,price){
                        ...
                        $('#price2').html('Rp 0');
                        $('#sum_of_price').html('Rp '+data.price * adult_amount);
                        $('#sum_of_price2').val(data.price * adult_amount);
        ...
        var rute_from =$('#rute_from').val();
       var url = "<?php echo base_url()  ?>index.php/reservation_train/get_namestasiun1/"+rute_from;
    $.get(url,function(e){
      $('#name_stasiun1').val(e);
    }) 
    });
        ...
        var rute_to = $('#rute_to').val();
        var url = "<?php echo base_url()  ?>index.php/reservation_train/get_namestasiun2/"+rute_to;
    $.get(url,function(e){
      $('#name_stasiun2').val(e);
    })
